    ...
    <div className="flex flex-col lg:flex-col justify-center space-y-4 lg:space-y-0">
      <div className="flex lg:flex-row md:flex-col">
        <div className="lg:w-1/2 mb-3 mx-20 my-20">
          <iframe
            className="google-map w-full lg:h-5/6 md:h-full rounded-3xl"
      ...
      <div className="lg:w-2/3 mx-auto">
        ...
        >
            ...
            <div className="flex justify-between">
              <div>
                ...
                <input
                  ...
                  name="full-name"
                  id="full-name"
                  className="bg-blue-50 p-3 rounded-full pr-40 mt-3 border border-2 border-transparent hover:border-green-500"
              ...
              <div className="mb-5">
                ...
                <input
                  ...
                  id="email"
                  pattern="[^ @]*@[^ @]*"
                  className="bg-blue-50 p-3 rounded-full mt-3 pr-40 border border-2 border-transparent hover:border-green-500"
                  placeholder="hammadsheikh@gmail.com"
                  required
                />
              </div>
            </div>
            <label htmlFor="message" className="my-5">
              Message
            </label>
            <textarea
              name="message"
              rows="6"
              className="bg-blue-50 p-3 rounded-3xl border border-2 border-transparent hover:border-green-500"
              id="message"
          ...
          <div className="flex my-5">
            <button
              type="submit"
              className="bg-green-500 text-white rounded-3xl px-10 py-4 mx-auto text-center"
            >
              Send Message
            </button>
          </div>
